...
def scan_reflected_xss(base_url):
    ...
    if "=" not in query:
        console.print("No Parameters Of Test", style="red")
        return
...
def scan_dom_xss(base_url):
    try:
        ...
        if found:
            ...
            console.print("No DOM Paterns found", style="red")
    except Exception as e:
        console.print(f"[ERROR] {str(e)}", style="red")
...
def main():
    ...
    console.print(menu)
    choice = Prompt.ask("> landmark ,", choices=["1", "2", "3", "0"], default="1")
    ...
    console.print("How Was Your TRIP!", style="green")
    exit()
